...
<body>
    ...
    <div id="sub_content">
        <form:form action="update" method="post" modelAttribute="res">
        ...
        <div class="row mb-4">
            ...
            <div class="col-md-4">
                <form:input class="form-control" path="id" id="id" value="${res.id}"/>
            </div>
        </div>
         <div class="row mb-4">
            <div class="col-md-2"></div>
            ...
            <div class="col-md-4">
                <form:input  path="name" class="form-control" id="name" value="${res.name}"/>
            </div>
        </div>
        ...
        <div class="row mb-4">
            ...
            <div class="col-md-4">
            	 <form:input class="form-control" path="email" id="email" value="${res.email}"/>
                
            </div>
        </div>
        <div class="row mb-4">
            <div class="col-md-2"></div>
            <form:label path="pas" class="col-md-2 col-form-label">Password</form:label>
            <div class="col-md-4">
                <form:password path="pas" class="form-control" id="password" value="${res.pas}"/>
            </div>
        </div>
              <div class="row mb-4"> 
             <div class="col-md-2"></div>  
             ...
             <div class="col-md-4">  
               <form:select  class="form-select" aria-label="Education" id="userRole" path="role">	             	 
                	 <option <c:if test="${res.role == 'Admin'}">selected</c:if>>Admin</option>  
                	 <option <c:if test="${res.role == 'User'}">selected</c:if>>User</option>  
                  </form:select>  
              </div>  
          </div>  
        <div class="row mb-4">
            ...
            <button type="button" class="btn btn-secondary col-md-2 " onclick="location.href = 'stb';">
                Back
            </button>
