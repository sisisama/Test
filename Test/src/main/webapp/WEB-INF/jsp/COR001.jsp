...
<body>
    <div id="testheader">
        <div class="container">
         ...
         <%@ page import="java.io.*" %>
          ...
          String c_id = cDao.generateCId();
          request.getSession().setAttribute("id", c_id);
          %>
      
        <div class="col-md-6">
            <p>User : ${sessionScope.namee}</p>
    ...
    <form:form action="coureg" method="post" modelAttribute="COR001">
        ...
        <div class="row mb-4">
            <div class="col-md-2"></div>
  			 <form:label path="name" class="col-md-2 col-form-label">Course Name</form:label>
            <div class="col-md-4">
